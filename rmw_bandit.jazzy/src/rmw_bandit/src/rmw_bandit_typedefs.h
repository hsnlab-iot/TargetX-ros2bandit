...
typedef bool (*rmw_feature_supported_t)(rmw_feature_t);
...
typedef rmw_ret_t (*rmw_take_dynamic_message_t)(const rmw_subscription_t *, rosidl_dynamic_typesupport_dynamic_data_t *, bool *, rmw_subscription_allocation_t *);
typedef rmw_ret_t (*rmw_take_dynamic_message_with_info_t)(const rmw_subscription_t *, rosidl_dynamic_typesupport_dynamic_data_t *, bool *, rmw_message_info_t *, rmw_subscription_allocation_t *);
typedef rmw_ret_t (*rmw_serialization_support_init_t)(const char *, rcutils_allocator_t *, rosidl_dynamic_typesupport_serialization_support_t *);
...
SET_FUNCTION_POINTER(rmw_feature_supported)
...
SET_FUNCTION_POINTER(rmw_take_dynamic_message)
SET_FUNCTION_POINTER(rmw_take_dynamic_message_with_info)
SET_FUNCTION_POINTER(rmw_serialization_support_init)
